...
public class Sampling_Scene extends Activity {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
            Toast.makeText(Sampling_Scene.this, "Service is disconnected", Toast.LENGTH_SHORT).show();
            mBounded = false;
            mWifiService = null;
        }
    };
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MessageType.DIGEST_DID_NOT_MATCH: {
                    ...
                    Toast.makeText(Sampling_Scene.this, "Photo not sent properly!", Toast.LENGTH_SHORT).show();
                ...
                case MessageType.MESSAGE_READ:
                    ...
                    //debug:
                    Log.i("Sampling_Scene ", String.valueOf(Utils.GetIndicator(readBuf)) );


                    switch (Utils.GetIndicator(readBuf)) {
                        case MessageType.toGLASS_Experiment_Scene:
            ...
            public boolean onGesture(Gesture gesture) {
                if (gesture == Gesture.LONG_PRESS || gesture == Gesture.TAP) {
                    ...
                    if (waitForYesNo) {
                        ...
                        mWifiService.write(MessageType.toHAYTHAM_Experiment_scene_Start);
