...
public abstract class MetaioCloudPluginBaseActivity extends FragmentActivity
{
	 ...
	 * 
	 * @return a class that extends {@link com.metaio.cloud.plugin.view.ARMetaioCloudPluginManager} which provides custom
	 ...
	 * Override this to provide your own implementation
	 *
	 * @return a class that extends {@link com.metaio.sdk.MetaioWorldPOIManagerCallback} which provides custom
	 *         implementation of some of the methods
	 */
