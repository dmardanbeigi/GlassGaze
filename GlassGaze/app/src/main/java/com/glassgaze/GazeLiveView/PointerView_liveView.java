...
public class PointerView_liveView extends RelativeLayout {
    ...
    public PointerView_liveView(Context context) {
        this(context, null, 0);
    }

    public PointerView_liveView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PointerView_liveView(Context context, AttributeSet attrs, int defStyleAttr) {
...
*/
    ...
    private void moveFingerTrace(int pointerId, float x, float y) {
        ...
        LayoutParams lp =
                (LayoutParams) fingerTraceView.getLayoutParams();
     ...
     */
    public void hideFingerTrace(int pointerId) {
        TextView fingerTraceView = mFingerTraceViews[pointerId];
