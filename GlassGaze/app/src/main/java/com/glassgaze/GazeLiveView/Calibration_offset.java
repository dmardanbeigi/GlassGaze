...
public class Calibration_offset extends Activity {
    ...
    PointerView_liveView mPointerViewLiveview;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
            Toast.makeText(Calibration_offset.this, "Service is disconnected", Toast.LENGTH_SHORT).show();
            mBounded = false;
            mWifiService = null;
        }
    };
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MessageType.DATA_SENT_OK: {
                    ...
                    Log.i("Calibration_Scene", "Photo was sent successfully");
                }
                break;

                case MessageType.DIGEST_DID_NOT_MATCH: {

                    Toast.makeText(Calibration_offset.this, "Photo not sent properly!", Toast.LENGTH_SHORT).show();
                ...
                case MessageType.MESSAGE_READ:
                    ...
                    switch (Utils.GetIndicator(readBuf)) {
                        case MessageType.toGLASS_Calibrate_Scene:
                            ...
                            }  else if (x0 == -5 && y0 == -5) {//look at the target again
                                //look at the next target
                                mWifiService.Speek("Try again!");
                                waitForYesNo = true;
                                //ShowCameraView();
                               // ShowTargetOverlay();
                                ...
                                currentPhoto = x0;
                                Log.i("Calibration_Scene", "taking picture");
        ...
        public void handleMessage(final Message msg) {
            ...
            switch (msg.what) {
                ...
                case  MessageType.PHOTO_READY:
                    Log.i("Calibration_Scene", "ending photo");
    ...
    private void ShowTargetOverlay() {
        //TODO: right now we have seperate circles for each point. why not just drawing 4 points with only one pointer
        //TODO: we should get the point locations from the server later
        int offset = 100;
        int w = 640;
        int h = 360;
        mPointerViewLiveview.GazeEvent(w/2, h/2, 2);
        //mPointerViewLiveview.GazeEvent(offset, offset, 2);
        //mPointerViewLiveview.GazeEvent(w - offset, offset, 3);
        //mPointerViewLiveview.GazeEvent(offset, h - offset, 4);
        //mPointerViewLiveview.GazeEvent(w - offset, h - offset, 5);


    }
    private void HideTargetOverlay() {
        mPointerViewLiveview.hideFingerTrace(2);
        //mPointerViewLiveview.hideFingerTrace(3);
        //mPointerViewLiveview.hideFingerTrace(4);
        //mPointerViewLiveview.hideFingerTrace(5);
 ...
 /*   Intent returnIntent = new Intent();
    ...
    protected void onCreate(Bundle bundle) {
        ...
        mPointerViewLiveview = (PointerView_liveView) findViewById(R.id.liveview_pointerView);
        // mPointerViewLiveview.setBackgroundColor(Color.BLACK);
